...
if url:
    ...
    if ".xml" not in url:
        ...
        with st.sidebar:
            st.error("Please write word to filter pages")
    else:
    ...
    Start by writing the URL's sitemap.xml of the website on the sidebar.
    
    Example:
    
    https://openai.com/sitemap.xml
    
    https://www.sheridancollege.ca/sitemap.xml
    
    https://www.canada.ca/en/immigration-refugee.sitemap.xml
